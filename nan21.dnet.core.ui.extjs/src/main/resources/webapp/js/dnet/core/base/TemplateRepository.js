...
dnet.core.base.TemplateRepository = {                                                                                                                                                                                  
   ...
   ,APPLICATION_HOME :
       ...
       // +"<tr><td><img src='resource/images/plane_blue_apps.jpg' width='500px' vspace='0' border='0' alt='top_newsletter' title='Image' /></td></tr>"
        ...
        +"  </ul>"
        + "  <a href='http://www.dnet-ebusiness-suite.com' target=_blank>www.dnet-ebusiness-suite.com</a>"
        +" <tr><td ><br> &copy; Nan21 Electronics SRL </td> </tr>"
        +"</td></tr>"
        +"</table>"
  ,APPLICATION_ABOUT_BOX:
         "<table width='100%' border='0' align=center cellpadding='0' cellspacing='0' style='font-family: arial, sans-serif;line-height: 140%;font-size:10pt; '>"
       // +"<tr><td><img src='resource/images/plane_blue_apps.jpg' width='500px' vspace='0' border='0' alt='top_newsletter' title='Image' /></td></tr>"
        +"<tr><td><h2 style='text-align: center;font-family: arial, sans-serif;font-size:16pt;margin-top: 20px;' > <br>{dnetName} </h2> </td></tr>"
        +"<tr><td><h5 style='text-align: center;font-family: arial, sans-serif;font-size:10pt;margin-top: 5px;' > Version: {dnetVersion} </h5> </td></tr>"
        +"<tr><td style='text-align: center;'>"
        +"  <br>Open source ERP / CRM / HRM."
      	+"  </td></tr>"
		+" <tr><td  style='text-align: center;'>  <a href='http://www.dnet-ebusiness-suite.com' target=_blank>www.dnet-ebusiness-suite.com</a> </td> </tr>"
		+" <tr><td  style='text-align: center;'><br> &copy; Nan21 Electronics SRL </td> </tr>"
        +"  </td></tr>"
        +"</table>"
  ,ABOUT_DASHBOARD : "" +
