...
dnet.base.UrlBuilder =  {
	...
	,_buildUrl_: function(o) {
		if (!(o[__Http__.REQUEST_PARAM_RESOURCE_TYPE] && o[__Http__.REQUEST_PARAM_RESOURCE_NAME] && o[__Http__.REQUEST_PARAM_DATA_FORMAT]) )  {
        ...
        url += "/"+o[__Http__.REQUEST_PARAM_RESOURCE_NAME]+"."+o[__Http__.REQUEST_PARAM_DATA_FORMAT]+"?";
    ...
    ,urlSave: function(pDc, pFormat, pIsInsert) {
		...
		o[__Http__.REQUEST_PARAM_RESOURCE_TYPE] = __Http__.RESOURCE_TYPE_DC;
		o[__Http__.REQUEST_PARAM_RESOURCE_NAME] = pDc;
		o[__Http__.REQUEST_PARAM_ACTION] = (pIsInsert)?__Http__.REQUEST_PARAM_ACTION_INSERT:__Http__.REQUEST_PARAM_ACTION_UPDATE;
		o[__Http__.REQUEST_PARAM_DATA_FORMAT] = pFormat;
		return this._buildUrl(o);
	}
