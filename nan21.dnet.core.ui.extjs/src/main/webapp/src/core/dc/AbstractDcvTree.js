...
dnet.base.AbstractDcvTree = Ext.extend( Ext.tree.TreePanel, {
	...
	,initComponent: function(config) {
        ...
        Ext.apply(this,cfg);
		dnet.base.AbstractDcvTree.superclass.initComponent.call(this);
		//this._controller_.store.on("load", function(store,records,options) { this._onStoreLoad_(store,records,options);}, this);
