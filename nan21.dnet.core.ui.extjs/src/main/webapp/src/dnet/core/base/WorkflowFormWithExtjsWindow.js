...
Ext.define("dnet.core.base.WorkflowFormWithExtjsWindow", {
	extend:  "Ext.Window" ,
	...
	constructor: function(config) {
		...
		dnet.core.base.WorkflowFormWithExtjsWindow.superclass.constructor.call(this, cfg);

	}
	
	, initComponent: function() {
		  
		dnet.core.base.WorkflowFormWithHtmlWindow.superclass.initComponent.call(this);
