...
//		if (this._reports_ != null) {
//			var rmap = new Ext.util.MixedCollection();
//			for(var i=0,l=this._reports_.length; i<l;i++) {
//				rmap.add(this._reports_[i]);
//			}
//			this._reports_ = rmap;
//		}
	...
	_beforeDefineActions_ : function() {
		return true;
	},
	...
	_beforeDefineDcRelations_ : function() {
		return true;
	},
	...
	_defineBindings_ : function() {
		/*
		 * this._dcs_.eachKey(function(dcName,dc) { var dcvs =
		 * this._elems_.filterBy( function(e) { return (e._dcViewType_ ==
		 * "edit-form" && e._controller_ && e._controller_ ==
		 * this._dcs_.get(dcName) ); }, this ); var views = [];
		 * dcvs.eachKey(function(dcvName, dcv) { views[views.length]=dcvName;
		 * },this); this._getBuilder_().createBinding(dcName,views); },this);
		 */
	},

	_beforeDefineBindings_ : function() {
		return true;
	},
